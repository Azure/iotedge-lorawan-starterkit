...
- In case of two gateways and high message rates (10 messages per second), we saw that the delivery latency spiked for one of the two gateways. This behavior did not occur with lower message rates (3 messages per second).
