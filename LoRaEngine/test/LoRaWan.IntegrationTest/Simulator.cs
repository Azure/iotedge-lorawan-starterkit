...
//         private PacketForwarderSimulator gateway;
...
//                                 {
//                                     string device = "";
//                                     if (dev.LoRaDevice.DeviceID != "")
//                                         device = dev.LoRaDevice.DeviceID;
//                                     else
...
//                                     {
//                                         TestLogger.Log($"[{device}] Confirmation receiveced");
//                                     }
...
//                                             TestLogger.Log($"[{device}] Received a non LoRa message");
//                                         }
//                                         else
//                                         {
...
//                                             {
//                                                 TestLogger.Log($"[{device}] Received join accept");
...
//                                                 var devNonce = ConversionHelper.StringToByteArray(dev.DevNonce);
//                                                 Array.Reverse(devNonce);
//                                                 var appSKey = payload.CalculateKey(LoRaPayload.KeyType.AppSKey, appNonce, netid, devNonce, ConversionHelper.StringToByteArray(dev.LoRaDevice.AppKey));
//                                                 dev.LoRaDevice.AppSKey = BitConverter.ToString(appSKey).Replace("-", "");
//                                                 var nwkSKey = payload.CalculateKey(LoRaPayload.KeyType.NwkSKey, payload.AppNonce.ToArray(), netid, devNonce, ConversionHelper.StringToByteArray(dev.LoRaDevice.AppKey));
//                                                 dev.LoRaDevice.NwkSKey = BitConverter.ToString(nwkSKey).Replace("-", "");
//                                                 dev.NetId = BitConverter.ToString(netid).Replace("-", "");
//                                                 dev.AppNonce = BitConverter.ToString(appNonce).Replace("-", "");
