...
namespace LoRaWan.NetworkServer.Test
{
    ...
    public class LoRaOperationTimeWatcherTest
    {
        ...
        {
            var target = new LoRaOperationTimeWatcher(LoRaTools.Regions.Region.EU, DateTimeOffset.UtcNow.Subtract(TimeSpan.FromSeconds(1)));
        ...
        {
            var target = new LoRaOperationTimeWatcher(LoRaTools.Regions.Region.EU, DateTimeOffset.UtcNow.Subtract(TimeSpan.FromSeconds(5)));
            var actual = target.GetRemainingTimeToJoinAcceptFirstWindow();
        ...
        {
            var target = new LoRaOperationTimeWatcher(LoRaTools.Regions.Region.EU, DateTimeOffset.UtcNow.Subtract(TimeSpan.FromSeconds(3)));
        ...
        {
            var target = new LoRaOperationTimeWatcher(LoRaTools.Regions.Region.EU, DateTimeOffset.UtcNow.Subtract(TimeSpan.FromSeconds(6)));
        ...
        {
            var target = new LoRaOperationTimeWatcher(LoRaTools.Regions.Region.EU, DateTimeOffset.UtcNow.Subtract(TimeSpan.FromMilliseconds(delayInMs)));
        ...
        {
            var target = new LoRaOperationTimeWatcher(LoRaTools.Regions.Region.EU, DateTimeOffset.UtcNow.Subtract(TimeSpan.FromSeconds(4)));
            var loRaDevice = new LoRaDevice("31312", "312321321", null);
