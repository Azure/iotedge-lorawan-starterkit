...
#pragma warning restore CA5358 // Review cipher mode usage with cryptography experts
        ...
        public DownlinkPktFwdMessage Serialize(string appKey, string datr, double freq, string devEui, long tmst, ushort lnsRxDelay = 0, StationEui stationEui = default)
        {
            ...
            return new DownlinkPktFwdMessage(GetByteMessage(), datr, freq, devEui, tmst, lnsRxDelay, stationEui: stationEui);
        }
    }
}
