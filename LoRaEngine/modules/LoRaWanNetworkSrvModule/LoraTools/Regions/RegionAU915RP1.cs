...
namespace LoRaTools.Regions
{
    ...
    // Frequency plan for region AU915-928 using version RP001-1.0.3 of LoRaWAN Regional Parameters specification
    public class RegionAU915RP1 : DwellTimeLimitedRegion
    {
        ...
        private static readonly ImmutableDictionary<DataRateIndex, (DataRate DataRate, uint MaxPayloadSize)> DrToConfigurationByDrIndex =
            new Dictionary<DataRateIndex, (DataRate DataRate, uint MaxPayloadSize)>
            {
                ...
                [DR6] = (LoRaDataRate.SF8BW500, MaxPayloadSize: 230),
                [DR8] = (LoRaDataRate.SF12BW500, MaxPayloadSize: 41),
                [DR9] = (LoRaDataRate.SF11BW500, MaxPayloadSize: 117),
                [DR10] = (LoRaDataRate.SF10BW500, MaxPayloadSize: 230),
                [DR11] = (LoRaDataRate.SF9BW500, MaxPayloadSize: 230),
                [DR12] = (LoRaDataRate.SF8BW500, MaxPayloadSize: 230),
                [DR13] = (LoRaDataRate.SF7BW500, MaxPayloadSize: 230),
        ...
        protected override DwellTimeSetting DefaultDwellTimeSetting => new DwellTimeSetting(false, false, 10);
            ...
            : base(LoRaRegionType.CN470RP2)
        {
            ...
            MaxADRDataRate = DR6;
            RegionLimits = new RegionLimits((Min: Mega(915.2), Max: Mega(927.8)), validDatarates, validDatarates, 0, 0);
