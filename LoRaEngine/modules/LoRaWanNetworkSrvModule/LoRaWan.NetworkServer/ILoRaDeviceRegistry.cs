...
namespace LoRaWan.NetworkServer
{
    ...
    public interface ILoRaDeviceRegistry : IDisposable
    {
        ...
        /// </summary>
        Task<LoRaDevice> GetDeviceForJoinRequestAsync(string devEUI, DevNonce devNonce);

        /// <summary>
        /// Updates device after a succesfull join request.
        /// </summary>
        void UpdateDeviceAfterJoin(LoRaDevice loRaDevice, DevAddr oldDevAddr = default);
