...
namespace LoRaWan.NetworkServer
{
    ...
    internal static class MetricRegistry
    {
        ...
        public static readonly CustomMetric DeviceLoadRequests = new CustomMetric("DeviceLoadRequests", "Number of device load requests", MetricType.Counter, new[] { GatewayIdTagName, ConcentratorIdTagName });
