...
namespace LoRaWan.Shared
{
    ...
    public sealed class ApiVersion : IComparable<ApiVersion>
    {
        ...
        {
            return other != null && other.IsKnown && this.IsKnown && this >= other;
        }
        ...
        /// </summary>
        public static ApiVersion Version_0_2_Or_Earlier { get; } = new ApiVersion("", "0.2 or earlier");

        /// <summary>
        /// Version 0.3 -> Released on 2018-12-16
        /// </summary>
        public static ApiVersion Version_2018_12_16_Preview { get; } = new ApiVersion("2018-12-16-preview");


        /// <summary>
        /// Planned Version 0.4 -> Released on 2019-01-30 // no real dates, just used for testing
        /// </summary>
        public static ApiVersion Version_2019_01_30_Preview { get; } = new ApiVersion("2019-01-30-preview");
