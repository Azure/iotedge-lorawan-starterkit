...
namespace LoRaWan.NetworkServer.BasicsStation
{
    ...
    public class BasicStationToRxpk : Rxpk
    {
        ...
        public BasicStationToRxpk(RadioMetadata radioMetadata, Region region)
        {
            ...
            Tmst = (uint)(radioMetadata.Xtime & 0xFFFFFFFF); // https://github.com/lorabasics/basicstation/blob/bd17e53ab1137de6abb5ae48d6f3d52f6c268299/examples/station2pkfwd/pkfwdc.py#L145
            Freq = radioMetadata.Frequency.Mega;
            Datr = region.DRtoConfiguration[(ushort)radioMetadata.DataRate.AsInt32].configuration;
            Rssi = Convert.ToInt32(radioMetadata.ReceivedSignalStrengthIndication);
            Lsnr = radioMetadata.SignalNoiseRatio;

            Rfch = radioMetadata.AntennaPreference; // This is not used in any computation. It is only reported in the device telemetry.
            ...
            Tmms = radioMetadata.GpsTime; // This is not used in any computation. It is only reported in the device telemetry.
            Time = radioMetadata.Xtime.ToString(CultureInfo.InvariantCulture); // This is not used in any computation. It is only reported in the device telemetry.
