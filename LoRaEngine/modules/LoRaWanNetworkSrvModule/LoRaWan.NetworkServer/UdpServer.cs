...
namespace LoRaWan.NetworkServer
{
    ...
    public class UdpServer : IDisposable, IPacketForwarder
    {
        ...
        public static UdpServer Create()
        {
            ...
            var dataHandlerImplementation = new DefaultLoRaDataRequestHandler(configuration, frameCounterStrategyProvider, new LoRaPayloadDecoder(), deduplicationStrategyFactory, adrStrategyProvider, new LoRAADRManagerFactory());
