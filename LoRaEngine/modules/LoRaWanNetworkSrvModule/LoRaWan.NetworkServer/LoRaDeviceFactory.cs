...
#pragma warning disable CA2000 // Dispose objects before losing scope
                ...
                this.connectionManager.Register(loRaDevice, this.CreateDeviceClient(deviceInfo.DevEUI, deviceInfo.PrimaryKey, deviceInfo.IoTHubHostName));
#pragma warning restore CA2000 // Dispose objects before losing scope
        ...
        private string CreateIoTHubConnectionString(string devEUI, string assignedIoTHubHostname)
        {
        ...
        public ILoRaDeviceClient CreateDeviceClient(string devEUI, string primaryKey, string assignedIoTHubHostName)
        {
            try
            {
                var partConnection = this.CreateIoTHubConnectionString(devEUI, assignedIoTHubHostName);
