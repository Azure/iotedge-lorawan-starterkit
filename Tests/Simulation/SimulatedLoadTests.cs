...
namespace LoRaWan.Tests.Simulation
{
    ...
    public sealed class SimulatedLoadTests : IntegrationTestBaseSim, IAsyncLifetime
    {
        ...
        {
            // 100 devices, 4 concentrators, 1 gateway.
