...
namespace LoRaWan.Tests.Common
{
    ...
    public static class LoRaPayloadExtensions
    {
        ...
        /// </summary>
        public static UplinkPktFwdMessage SerializeUplink(this LoRaPayloadJoinRequest request, string appKey, LoRaDataRate datr = null, double freq = 868.3, uint tmst = 0)
        {
