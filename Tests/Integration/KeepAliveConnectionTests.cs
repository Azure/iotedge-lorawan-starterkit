...
namespace LoRaWan.Tests.Integration
{
    ...
    public class KeepAliveConnectionTests : MessageProcessorTestBase
    {
        ...
        public async Task After_Disconnecting_Should_Reconnect()
        {
            ...
            using var request1 = CreateWaitableRequest(simulatedDevice.CreateUnconfirmedMessageUplink("1").Rxpk[0], PacketForwarder);
            ...
            using var request2 = CreateWaitableRequest(simulatedDevice.CreateUnconfirmedMessageUplink("2").Rxpk[0], PacketForwarder);
