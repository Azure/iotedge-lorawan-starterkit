...
namespace LoRaWan.Tests.Unit.LoRaTools.Regions
{
    ...
    public abstract class RegionTestBaseRxpk
    {
        ...
        [Obsolete("#655 - This Rxpk based implementation will go away as soon as the complete LNS implementation is done")]
        protected void TestDownstreamRX2FrequencyAndDataRate(string nwksrvrx2dr, double? nwksrvrx2freq, DataRate? rx2drfromtwins,
        ...
        [Obsolete("#655 - This Rxpk based implementation will go away as soon as the complete LNS implementation is done")]
        protected void TestDownstreamRX2DataRate(string nwksrvrx2dr, DataRate? rx2drfromtwins, string expectedDr, DeviceJoinInfo deviceJoinInfo = null)
        {
