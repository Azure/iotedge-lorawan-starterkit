    ...
    public class IoTHubRegistryManagerTest : FunctionTestBase
    {
        ...
        public async Task Page_Result_Executed()
        {
            ...
            queryMock.SetupGet(c => c.HasMoreResults)
                .Returns(() => (pageIndex * pageSize) < twins.Length);
            ...
            var deviceRegistry = new IoTHubDeviceRegistryManager(iotHubMock.Object, loggerMock.Object, this.iotHubHostName);
        ...
        public async Task Find_Device_By_Addr_Query_IoTHub()
        {
            ...
            var result = await deviceRegistry.FindDeviceByAddrAsync(CreateDevAddr());
